Two_Samp_Z_Interval  <- function(xbar1,sigma1, n1,xbar2,sigma2,n2,alpha){
  ...
  names(result) <- c("Confidence Level %", "Critical Value", "Margin of Error","Point Estimate","Lower Bound", "Upper Bound")
  return(result) 
}
